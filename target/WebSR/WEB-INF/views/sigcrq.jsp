...
<html>
<head>
    <title>Significant CRQ Detail</title>
    <style>
        .blue-button{
            background: #25A6E1;
...
<form:form name="UpdateItemForm" method="post" modelAttribute="crq" action="/WebSR/updates/sigcrqs/add">
    <table width="60%">
        <tr>
            <th>Signicant CRQs ( Please give NA if none)</th>
        </tr>
        <tr>
            <td><form:textarea name="description" rows="15" cols="200" size="15" maxlength="4000" placeholder="${crq.description}" required="required" path="description"/> </td>
        </tr>
        <tr>
