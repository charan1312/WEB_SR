...
<html>
<head>
    <title>Completed Item List</title>
    <style>
        .blue-button{
            background: #25A6E1;
...
<h3>
    <ul class="blue-button">
        Application List and Completed Action Items List
    </ul>
</h3>
...
<c:if test="${!empty apps}">
    <table width="60%">
        ...
        <tr>
            <th colspan="2">Total Number of Completed Action Items: ${totalCompletedCount}</th>
        </tr>
        ...
        <c:forEach items="${apps}" var="app" varStatus="index">
            ...
            <c:set var="hrefURL" value="${sep}${lowerDesc}${sep}${lowerDesc}${inactive}" />
            <tr>
                <td class="blue-button"><a href="<c:url value='${hrefURL}'/>"> ${app.description} </a></td>
                <td class="lightgray-button">Total count : ${appCompletedCount[i]} </td>
            </tr>
            <tr>
                <td colspan="2"><br></td>
            </tr>
...
<a href="<c:url value='/updates/vbvInActive'/>" > VBV </a>
</br>
<a href="<c:url value='/updates/vcasInActive'/>" > VCAS </a>
</br>
<a href="<c:url value='/updates/tpcasInActive'/>" > TPCAS </a>
</br>
<a href="<c:url value='/updates/vdnaInActive'/>" > VDNA </a>
